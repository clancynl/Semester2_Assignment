...
class Building(object):
    ...
    def run(self, elevator):
        while self.boarding or  self.elevator.passenger_list:
            ...
            #Allow customers off if required floor matches that in Passenger List - Disembarking
            for customer in self.elevator.passenger_list:
                self.elevator.disembarking_customer()
